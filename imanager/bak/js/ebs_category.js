...
function save(){
    ...
    if (saveType=='add' || saveType=='edit'){
        ...
        if (chineseName=='' || categoryType==''){$.messager.alert('提示','类别名称和类型为必填（选）项。','warning');}
            ...
            saveFlag = true;
            saveData = 'id='+primaryCode+'&cname='+chineseName+'&ename='+englishName+'&cimage='+imgUrl+'&shour='+startHour+'&sminute='+startMinute+'&ehour='+endHour+'&eminute='+endMinute+'&ctype='+categoryType+'&uid='+ck_itv_unit;
        }
    }
